export default function AnalyticsPage() {
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-xl font-semibold text-[var(--clarion-text)]">Analytics</h1>
        <p className="text-sm text-[var(--clarion-text-muted)] mt-1">Operational dashboards and strategic insights.</p>
      </div>
