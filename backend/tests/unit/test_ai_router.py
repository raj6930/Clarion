...
import pytest
from app.intelligence.router import AIRouter, TASK_DEFAULTS, EXTERNAL_REQUIRES_ANON
...
from app.intelligence.prompts.templates import (
    case_summary_prompt, sentiment_prompt, escalation_prediction_prompt,
    chatbot_query_prompt, anon_context_review_prompt,
)
...
class TestEngineResolution:
    ...
    def test_local_tasks_use_ollama(self):
        ...
        local_tasks = ["sentiment_analysis", "escalation_prediction", "chatbot_query", "pattern_detection"]
...
class TestPromptTemplates:
    def test_case_summary_prompt(self):
        case = {"sf_case_number": "00803992", "subject": "Test", "priority": "P2", "status": "Working", "product": "EcoSys", "case_age_days": 12, "case_owner_name": "Tim"}
    ...
    def test_escalation_prompt(self):
        case = {"sf_case_number": "123", "priority": "P1", "case_age_days": 20, "status": "Escalated", "sla_status": "Breached"}
...
class TestEngineResponse:
    def test_response_fields(self):
        resp = EngineResponse(
            text="Hello", engine="ollama", model="gemma2",
