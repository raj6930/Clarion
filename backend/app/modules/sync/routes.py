...
from app.auth.dependencies import CurrentUser, require_manager_or_admin
from app.modules.sync.schemas import SyncLogEntry, SyncStatusResponse, SyncTriggerRequest
