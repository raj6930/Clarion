...
from app.modules.anonymisation.schemas import (
    AnonymiseRequest, AnonymiseResponse, DetectedEntityResponse, MappingResponse,
    DeanonymiseRequest, DeanonymiseResponse,
    FlagFalsePositiveRequest, AddDictionaryRequest,
)
    ...
    return AnonymiseResponse(
        ...
        entities=[
            DetectedEntityResponse(
                ...
                detection_stage=e.detection_stage, confidence=e.confidence,
            ) for e in result.entities
        ],
        mappings=[
            MappingResponse(
                pseudonym=m.pseudonym, entity_type=m.entity_type,
                detection_stage=m.detection_stage, confidence=m.confidence,
