...
def cases_by_owner(owner_usernames: list[str], since: str | None = None) -> str:
...
def cases_by_account(account_ids: list[str], excluded_statuses: list[str], since: str | None = None) -> str:
