...
from app.intelligence.engine_adapters.base import BaseEngine, EngineResponse
...
class AIRouter:
    ...
    def resolve_engine(self, task: str, user_preference: str | None = None) -> str:
        """
    ...
    async def generate(
        ...
        max_tokens: int = 2000,
        anon_service: AnonymisationService | None = None,
    ) -> EngineResponse:
        """
